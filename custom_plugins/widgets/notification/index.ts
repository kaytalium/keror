...
export module notification {
    ...
    export let load = () => {
        ...
        $(document).ready(function () {
            ...
            let UI =
                '<div class="arrow-up notification-au"></div>' +
             ...
             */
            let HandleNotificationClicks = (n_obj: PluginInterface.NotificationMessage) => {
    ...
    export function checker(): Boolean {
        unread = MESSAGES.filter((obj: PluginInterface.NotificationMessage) => {
     ...
     * 
     */
    export function updater(msg: PluginInterface.NotificationMessage) {
...
const MESSAGES: Array<PluginInterface.NotificationMessage> = [
    {
        id: "0001",
